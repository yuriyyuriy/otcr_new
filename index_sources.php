		...
		<div class="container-fluid">
			<div class="navbar-header">
				<button class="navbar-toggle collapsed" data-target=".navbar-collapse" data-toggle="collapse" type="button"><span class="sr-only">Toggle navigation</span>
					<span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></button> <a class="navbar-brand" href="./index.php">Yash
						Technologies</a>
					</div>
					<div class="navbar-collapse collapse">
						<form action="index.php?go" class="navbar-form navbar-right" id="searchform" method="post" name="searchform">
							<div class="form-group">
								<input class="form-control" name="search_info" placeholder="Enter a search term" type="text">
							</div><button class="btn btn-default" name="search_go" type="submit" value="">Search</button>
						</form><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script> <script>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-3 col-md-2 sidebar">
						...
						<form action="index.php?filter_go_test" id="filterform" method="post" name="filter_go_test">
							<br>
							<?php
					...
					?><br>
					<button class="btn btn-default" name="filter_go" onclick="submit" value="">Filter</button> <button class="btn btn-default" name="clearall" onclick=
					" &lt;?php echo" type="button">"&gt;Clear All</button>
				</form><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script> <script src="js/jquery.cookie.js"></script> <script>
...
?>
	...
	<script src="js/bootstrap.min.js"></script> <script src="js/docs.min.js"></script> <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
	...
	</div><script src="js/bootstrap.min.js"></script> <script src="js/docs.min.js"></script> <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
	<script src="js/ie10-viewport-bug-workaround.js"></script>
	<div class="global-zeroclipboard-container" data-original-title="Copy to clipboard" id="global-zeroclipboard-html-bridge" style=
	"position: absolute; left: 0px; top: -9999px; width: 15px; height: 15px; z-index: 999999999;" title="">
	<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" height="100%" id="global-zeroclipboard-flash-bridge" width="100%">
