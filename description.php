  ...
  <div class="container-fluid">
    <div class="row">
      ...
      "col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		echo '<script> ModifyVals(); </script>';

		$sql="SELECT * FROM testtable WHERE Website LIKE '".$_GET['link']."'";
        ...
        <div class="row placeholders details"><!-- OPEN ROW CONTAINER-->
          <div class="col-xs-12 col-sm-6 col-md-6 column"><!-- OPEN COLUMN FOR PRIMARY INFO BOOSTRAP GRID-->
            ...
            <table class="table table-hover table-bordered text-left">
                <tr>
                  <td class="description-title col-md-4" id="sname">Source Name</td>
                  <td class="col-md-8"><?php echo $Name; ?></td>
                </tr>
                <tr>
                  <td class="description-title col-md-4" id="slink">Website Link</td>
                  <td class="col-md-8"><?php echo $Link; ?></td>
                </tr>
                <tr>
                  <td class="description-title col-md-4" id="sinudstry">Industry</td>
                  <td class="col-md-8"><?php echo $Industry; ?></td>
                </tr>
                <tr>
                  <td class="description-title col-md-4" id="slocation">Location</td>
                  <td class="col-md-8"><?php echo $Location; ?></td>
                </tr>
                <tr>
                  <td class="description-title col-md-4" id="savailability">Availability</td>
	...
	function ModifyVals(){
		...
		document.getElementById('slink').innerHTML= Name;
		document.getElementById('sindustry').innerHTML= Name;
		document.getElementById('savailability').innerHTML= Name;
		document.getElementById('slocation').innerHTML= Name;
		//Name, Link, Industry, Availability, Location
*/
	}
	</script>

        <h3 class="sub-header">Data Sets</h3>
		<div class="row placeholders" id="data_sets">
